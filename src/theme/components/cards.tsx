  ...
  return (
    <NextLink
      ...
      className={cn(
        classes.card,
        // Light normal
        'nx-bg-transparent nx-shadow-sm',
        // Light hover
        'hover:nx-bg-slate-50 hover:nx-shadow-md',
        // Dark normal
        'dark:nx-border-neutral-700 dark:nx-bg-dark-800',
        // Dark hover
        'dark:hover:nx-bg-dark-900 dark:hover:nx-border-neutral-600'
      )}
      {...props}
    >
      <span
